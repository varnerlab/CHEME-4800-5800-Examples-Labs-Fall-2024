...
function _writeframe(graph::SimpleDiGraph, visited::Set{Int64}, start::Int64, frameindex::Int64; prefix::String = "G_")
     
    # initialize -
    frame_path = joinpath(_PATH_TO_FRAMES, "$(prefix)frame_$(frameindex).png");
...
function _writeframe(graph::SimpleDiGraph, visited::Set{Int64}, frameindex::Int64; prefix::String = "G_")
